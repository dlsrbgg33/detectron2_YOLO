...
_C.INPUT.MIN_SIZE_TRAIN = [900,1350]
# _C.INPUT.MIN_SIZE_TRAIN_V = 800
...
_C.INPUT.CROP_SIZE = (800, 1600)
_C.INPUT.CROP_TYPE = "absolute"
_C.INPUT.CROP_ON = False 
...
_C.INPUT.CROP.SIZE = [1.0, 1.0]
# _C.INPUT.CROP.SIZE = [1.0, 1.0]
_C.INPUT.RATIO_RESIZE = True
...
_C.DATASETS.TASK_VIDEO = False
_C.DATASETS.TASK_VIDEO_DA = False
_C.DATASETS.INF_START = 0
# Video intervals between ref and targets in training
_C.DATASETS.INTERF_TRAIN = 5
# Video intervals betweeen ref and targets in test
_C.DATASETS.INTERF_TEST  = 5
_C.DATASETS.VID_CHOICE = ''
_C.DATASETS.SKIP_EVAL = 5
_C.DATASETS.REV_TEST = False
# -----------------------------------------------------------------------------
# DataLoader
# -----------------------------------------------------------------------------
_C.DATALOADER = CN()
...
_C.MODEL.FCOS.NORM = "" # Support "GN" or none
...
# EXTRA_NECK Head
# ---------------------------------------------------------------------------- #
_C.MODEL.EXTRA_NECK = CN()
_C.MODEL.EXTRA_NECK.NAME = ""
_C.MODEL.EXTRA_NECK.IN_CHANNELS = 256
_C.MODEL.EXTRA_NECK.NUM_LEVELS = 4
_C.MODEL.EXTRA_NECK.REFINE_LEV = 0
_C.MODEL.EXTRA_NECK.NFRAMES = 0
_C.MODEL.EXTRA_NECK.CENTER = 0
_C.MODEL.EXTRA_NECK.REFINE_TYPE = 'conv'
_C.MODEL.EXTRA_NECK.EXTRA_ON = True
...
# ---------------------------------------------------------------------------- #
_C.MODEL.SEM_SEG_HEAD = CN()
_C.MODEL.SEM_SEG_HEAD.NAME = ""
_C.MODEL.SEM_SEG_HEAD.IN_CHANNELS = 256
_C.MODEL.SEM_SEG_HEAD.OUT_CHANNELS = 128
_C.MODEL.SEM_SEG_HEAD.NUM_LEVELS = 4
_C.MODEL.SEM_SEG_HEAD.NUM_CLASSES = 16
_C.MODEL.SEM_SEG_HEAD.IGNORE_LABEL = 255
_C.MODEL.SEM_SEG_HEAD.LOSS_WEIGHT = 1.0
...
_C.TEST.DETECTIONS_PER_IMAGE = 20
