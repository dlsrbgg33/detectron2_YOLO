...
class Visualizer:
    ...
    def draw_sem_seg(self, sem_seg, area_threshold=0, alpha=1.0, dataset=False, viper=True):
        """
        Draw semantic segmentation predictions/labels.
        ...
        if viper:
            ...
            from cityscapesScripts.cityscapesscripts.helpers.labels_viper_city import id2label, trainId2label
    ...
    def draw_dataset_dict(self, dic):
        ...
        bool_ = 'viper' in dic["sem_seg_file_name"]
        if sem_seg is not None:
            self.draw_sem_seg(sem_seg, area_threshold=0, alpha=0.9, dataset=bool_)
        return self.output
