...
labels = [
    ...
    Label(  'traffic sign'         , 20 ,        9 , 'object'          , 3       , False        , False        , (220,220,  0) ),
    ...
    Label(  'train'                , 31 ,       15 , 'vehicle'         , 7       , True         , True        , (  0, 80,100) ),
...
# id to label object
id2label_r        = { label.id      : label for label in labels           }
# trainId to label object
trainId2label_r   = { label.trainId : label for label in reversed(labels) }
